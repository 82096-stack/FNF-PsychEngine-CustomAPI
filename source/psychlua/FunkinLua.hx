...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('vsync', ClientPrefs.data.vsync);
		set('graphicsAPI', ClientPrefs.data.graphicsAPI);
		set('framerate', FlxG.drawFramerate); // Current effective framerate (read-only in practice)
