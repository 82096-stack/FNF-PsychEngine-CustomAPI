...
class VideoSprite extends FlxSpriteGroup
{
	...
	{
		return videoSprite != null ? haxe.Int64.toInt(videoSprite.bitmap.time) / 1000.0 : 0.0;
	}

	public function getDuration():Float
	{
		return videoSprite != null ? haxe.Int64.toInt(videoSprite.bitmap.length) / 1000.0 : 0.0;
	}

	public function seek(seconds:Float):Void
	{
		if (videoSprite != null)
			videoSprite.bitmap.time = haxe.Int64.ofInt(Std.int(seconds * 1000));
	}
	#end
}
